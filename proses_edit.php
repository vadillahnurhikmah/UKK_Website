  ...
  if($gambar!= "") {
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {
      move_uploaded_file($file_tmp, 'gambar/'.$gambar_edit);   
        $query  = "UPDATE tabel_buku SET judul = '$judul', pengarang = '$pengarang', penerbit = '$penerbit', gambar = '$gambar_edit'";
      ...
      $query  = "UPDATE tabel_buku SET judul = '$judul', pengarang = '$pengarang', penerbit = '$penerbit', gambar = '$gambar'";
      $query .= "WHERE id_buku = '$id'";
      $result = mysqli_query($koneksi, $query);
